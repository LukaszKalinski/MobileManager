...
public class DatabaseNewFoundPlayer {
    ...
    public DatabaseNewFoundPlayer(Context context, String login) {
        this.login = login;
        this.context = context;

        this.DATABASE_NAME = "ScoutedIn" + login;
        this.DATABASE_TABLE = "ScoutedPlayer" + login;
    ...
    public long findNextPlayer(String name, String position, int gkSkills, int defSkills, int attSkills, int wage, int value){
        ContentValues initialValues = new ContentValues();
        initialValues.put(KEY_NAME, name);
        initialValues.put(KEY_POSITION, position);
        initialValues.put(KEY_GK_SKILLS, String.valueOf(gkSkills));
        ...
        initialValues.put(KEY_CONTRACT_WAGE, String.valueOf(wage));
        initialValues.put(KEY_VALUE, String.valueOf(value));
        return db.update(DATABASE_TABLE, initialValues, null, null);
    }
